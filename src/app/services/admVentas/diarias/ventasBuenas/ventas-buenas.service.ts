...
export class VentasBuenasService {
  ...
  updateVenta(reporte: any): Promise<any> {
    const registroRef = doc(this.firestore, `venta_dia_sms/${reporte.id}`);
